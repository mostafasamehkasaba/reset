      ...
      <div className="flex w-full gap-5 px-6 py-6" dir="ltr">
        <main className="flex-1 space-y-4" dir="rtl">
          <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-sm">
            <div className="text-right text-lg font-semibold text-slate-700">ط¨ظٹط§ظ†ط§طھ ط§ظ„ظ…ظ†طھط¬</div>
          </div>
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            <div className="grid gap-4 lg:grid-cols-2">
              <div className="space-y-2">
                ...
                <div className="rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm">ظ‚ط§ظ„ط¨ ظˆظˆط±ط¯ط¨ط±ظٹط³</div>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-semibold text-slate-700">ط§ظ„ظپط¦ط©</label>
                <div className="rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm">طھطµظ…ظٹظ…</div>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-semibold text-slate-700">ط§ظ„ط³ط¹ط±</label>
                <div className="rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm">USD 20</div>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-semibold text-slate-700">ط§ظ„ظƒظ…ظٹط© ط§ظ„ظ…ط¨ط§ط¹ط©</label>
