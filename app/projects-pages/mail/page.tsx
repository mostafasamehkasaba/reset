          ...
          <div className="space-y-4 rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-500">
                سيتم استخدام هذا البريد الإلكتروني لإرسال رسائل البريد الإلكتروني. اتركه فارغاً لاستخدام بريد SMTP الإلكتروني.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <button className="rounded-full bg-[#071a2c] px-8 py-2 text-sm text-white">حفظ</button>
            </div>
          </div>
        </main>
