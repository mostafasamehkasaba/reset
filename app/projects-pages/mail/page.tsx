      ...
      <div className="flex w-full gap-5 px-6 py-6" dir="ltr">
        <main className="flex-1 space-y-4" dir="rtl">
          <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-sm">
            <div className="text-right text-lg font-semibold text-slate-700">ط§ظ„ط¨ط±ظٹط¯</div>
          </div>

          <div className="space-y-4 rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            <div className="space-y-2">
              <label className="text-sm font-semibold text-slate-700">ط§ظ„ط¨ط±ظٹط¯ ط§ظ„ط¥ظ„ظƒطھط±ظˆظ†ظٹ ظ„ظ„طھظˆط§طµظ„</label>
              <input className="w-full rounded-md border border-slate-200 px-3 py-2 text-sm" />
              <p className="text-xs text-slate-500">
                ط³ظٹطھظ… ط§ط³طھط®ط¯ط§ظ… ظ‡ط°ط§ ط§ظ„ط¨ط±ظٹط¯ ط§ظ„ط¥ظ„ظƒطھط±ظˆظ†ظٹ ظ„ط¥ط±ط³ط§ظ„ ط±ط³ط§ط¦ظ„ ط§ظ„ط¨ط±ظٹط¯ ط§ظ„ط¥ظ„ظƒطھط±ظˆظ†ظٹ. ط§طھط±ظƒظ‡ ظپط§ط±ط؛ط§ظ‹ ظ„ط§ط³طھط®ط¯ط§ظ… ط¨ط±ظٹط¯ SMTP ط§ظ„ط¥ظ„ظƒطھط±ظˆظ†ظٹ.
              </p>
            </div>

            {[
              { label: "ظ…ط¶ظٹظپ SMTP", value: "" },
              { label: "ظ…ط³طھط®ط¯ظ… SMTP", value: "" },
              { label: "ظƒظ„ظ…ط© ظ…ط±ظˆط± SMTP", value: "" },
              { label: "ظ…ظ†ظپط° SMTP", value: "" },
            ].map((field) => (
              <div key={field.label} className="space-y-2">
                <label className="text-sm font-semibold text-slate-700">{field.label}</label>
                <input
                  type={field.label.includes("ظƒظ„ظ…ط© ظ…ط±ظˆط±") ? "password" : "text"}
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <button className="rounded-full bg-brand-900 px-8 py-2 text-sm text-white">ط­ظپط¸</button>
            </div>
          </div>
        </main>

        <Sidebar activeLabel="ط§ظ„ط¨ط±ظٹط¯" />
      </div>
    </div>
  );
}
