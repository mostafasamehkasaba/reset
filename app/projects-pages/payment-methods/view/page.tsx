      ...
      <div className="flex w-full gap-5 px-6 py-6" dir="ltr">
        <main className="flex-1 space-y-4" dir="rtl">
          <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-sm">
            <div className="text-right text-lg font-semibold text-slate-700">ط¨ظٹط§ظ†ط§طھ ظˆط³ظٹظ„ط© ط§ظ„ط¯ظپط¹</div>
          </div>
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            <div className="grid gap-4 lg:grid-cols-2">
              <div className="space-y-2">
                ...
                <div className="rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm">ط§ظ„ط¨ظ†ظƒ ط§ظ„ظˆط·ظ†ظٹ</div>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-semibold text-slate-700">ط§ظ„ظ†ظˆط¹</label>
                <div className="rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm">ط¨ظ†ظƒظٹ</div>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-semibold text-slate-700">ط§ظ„ظ…ط¬ظ…ظˆط¹</label>
              ...
              <div className="space-y-2">
                ...
                <div className="rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm">ط§ط­ظ…ط¯ 1233456789</div>
              </div>
            </div>
          </div>
        </main>
