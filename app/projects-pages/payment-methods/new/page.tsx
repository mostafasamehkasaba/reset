      ...
      <div className="flex w-full gap-5 px-6 py-6" dir="ltr">
        <main className="flex-1 space-y-4" dir="rtl">
          <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-sm">
            <div className="text-right text-lg font-semibold text-slate-700">ظˆط³ظٹظ„ط© ط¯ظپط¹ ط¬ط¯ظٹط¯ط©</div>
            <Link
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            <div className="grid gap-4 lg:grid-cols-2">
              <div className="space-y-2">
                <label className="text-sm font-semibold text-slate-700">ط§ط³ظ… ط§ظ„ظˆط³ظٹظ„ط©</label>
              ...
              <div className="space-y-2">
                ...
                <select className="w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm">
                  <option>ط¨ظ†ظƒظٹ</option>
                  <option>ط¨ط·ط§ظ‚ط©</option>
                  <option>ظ…ط­ظپط¸ط© ط±ظ‚ظ…ظٹط©</option>
                </select>
              </div>
              <div className="space-y-2">
